...
export function PricingBreakdown({ 
  ...
  useEffect(() => {
    calculatePricing();
  }, [productPrice, isTaxable, isShippingExempt, quantity]);
  ...
  const calculatePricing = async () => {
    ...
    try {
      ...
      // Simulate tax calculation (10% GST for taxable items)
      const taxRate = isTaxable ? 10 : 0;
      const taxAmount = (subtotal * taxRate) / 100;
      
      // Simulate shipping calculation
      const shippingAmount = isShippingExempt ? 0 : (subtotal >= 99 ? 0 : 9.95);
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-brown-700">
            <span className="flex items-center">
              ...
              {!isShippingExempt && parseFloat(calculation.subtotal) >= 99 && (
          ...
          {showBreakdown && (
            <div className="mt-4 pt-4 border-t border-brown-200 text-sm text-brown-600 space-y-2">
              ...
              <div className="text-xs text-brown-500">
                • GST (10%) applies to taxable items in Australia<br/>
                • Free shipping on orders over $99 (unless product is shipping exempt)<br/>
